...
public interface ECMAScriptListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterNumberExpression(@NotNull ECMAScriptParser.NumberExpressionContext ctx);
	/**
	 * Exit a parse tree produced by the {@code NumberExpression}
	 * labeled alternative in {@link ECMAScriptParser#singleExpression}.
	 * @param ctx the parse tree
	 */
	void exitNumberExpression(@NotNull ECMAScriptParser.NumberExpressionContext ctx);
	/**
